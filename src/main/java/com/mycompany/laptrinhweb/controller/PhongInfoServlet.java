 ...
 * @author DELL
 */
public class PhongInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!maPhongStr.isEmpty()){
            ...
            List<RoomBookingStatusDTO> listBooking = roomDAO.getRoomBookingStatusByRoomId(maPhong);
            request.setAttribute("room", room);
            request.setAttribute("listBooking", listBooking);
            request.getRequestDispatcher("watch-room-customer.jsp").forward(request, response);
            return;
        }
