...
public class CheckInServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int maphong = Integer.parseInt(request.getParameter("maP"));
        int madatphong= Integer.parseInt(request.getParameter("maDP"));
        CustomerDAO customerDAO = new CustomerDAO();
        if (customerDAO.checkIn(madatphong, maphong)){
            request.setAttribute("msg", "Check-in successfully");
        }
        else{
